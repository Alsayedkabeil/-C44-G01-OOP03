namespace OOP03
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            IAuthenticationService iauthService = authService;
            iauthService.AuthenticateUser("Alsayed", "password123");
            iauthService.AuthorizeUser("Alsayed","admin");
            iauthService.AuthorizeUser("Ali","user");
